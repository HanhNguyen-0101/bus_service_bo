...
passengerCarCompaniesRouter.post("/", authenticate, authorize([USER_TYPE.ADMIN, USER_TYPE.SUPER_ADMIN]), uploadImage("image"), create);
passengerCarCompaniesRouter.get("/", getAll);
passengerCarCompaniesRouter.get("/:id", checkExits(passengerCarCompanies), getDetail);
passengerCarCompaniesRouter.put("/:id", authenticate, authorize([USER_TYPE.ADMIN, USER_TYPE.SUPER_ADMIN]), checkExits(passengerCarCompanies), uploadImage("image"), update);
passengerCarCompaniesRouter.delete("/:id", authenticate, authorize([USER_TYPE.ADMIN, USER_TYPE.SUPER_ADMIN]), checkExits(passengerCarCompanies), remove);
