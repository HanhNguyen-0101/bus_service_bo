...
const getURL = (url) => {
  return `./public/data/passengerCarCompanies/${url}.json`;
};
...
module.exports = {
  passengerCarCompanies: {
    findAll: (obj) => findAll("passengerCarCompanies", obj),
    findOne: (obj) => findOne("passengerCarCompanies", obj),
    destroy: (id) => destroy("passengerCarCompanies", id),
    create: (item) => create("passengerCarCompanies", item),
    update: (id, item) => update("passengerCarCompanies", id, item),
  },
};
